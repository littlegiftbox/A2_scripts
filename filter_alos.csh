...
#####################DEBUG
# something wrong with input data $1 $2
# something wrong with amp1, amp2
# something wrong with realfilt.grd (have no z value)
...
#####################DEBUG
# something wrong with display_amp.grd (have no z value)
# something wrong with AMAX
